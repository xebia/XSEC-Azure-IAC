...
resource "azurerm_linux_virtual_machine_scale_set" "res-1" {
  ...
  sku                    = "Standard_D2_v2"
  source_image_id        = "/subscriptions/109a5e88-712a-48ae-9078-9ca8b3c81345/resourceGroups/AKS-Ubuntu/providers/Microsoft.Compute/galleries/AKSUbuntu/images/1804containerd/versions/2023.02.15"
  tags = {
